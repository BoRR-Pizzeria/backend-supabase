...
## 9. Documentación bajo `doc/`

**Decisión**: Toda la documentación de modelo, decisiones, capacidades y futuro vive bajo `doc/`. El `README.md` raíz se mantiene técnico (stack, scripts, estructura de código).

**Por qué**:
- **Separación de audiencias**: dev que abre el repo ve el `README.md`; quien necesita entender el negocio o el modelo entra a `doc/`.
- **Evita inflar la raíz** con archivos de documentación heterogénea.
