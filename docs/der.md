...
El razonamiento detrás de cada decisión está en [`decisiones-modelo-datos.md`](./decisiones-modelo-datos.md). Un ejemplo concreto del flujo está en [`ejemplos/pedido-mixto.md`](./ejemplos/pedido-mixto.md).
